...
if (!class_exists(__NAMESPACE__ . '\CmindsFreePackage')) {
    ...
    class CmindsFreePackage {
        ...
        public function __construct($config) {
            ...
            add_action('activated_plugin', array($this, 'redirectAfterInstall'), 5, 2);
        ...
        public function updateMenu() {
			...
			if ($this->getOption('plugin-show-shortcodes') && $this->getOption('plugin-shortcodes')) {
				add_submenu_page($this->getOption('plugin-menu-item'), __('Shortcodes', 'cminds-package'), __('Shortcodes', 'cminds-package'), 'manage_options', $this->getOption('plugin-abbrev') . '_shortcodes', array($this, 'displayShortcodesPage'));
			}
		...
		public function displayShortcodesPage() {
            ?>
			<style>
			.cm:after { content: ''; clear: both; display: block; }
			.cm img { max-width: 99%; }
			.cm .cmlp-box { width: 49%; float: left; position: relative; min-height: 1px; }
			.cmlp-padding { padding-left: 0px; padding-right: 0px; box-sizing: border-box; }
			.cm .cmlp-left.cmlp-box .ebook { padding: 0; -webkit-box-shadow: none; box-shadow: none; }
			.cm .label-video { margin-bottom: 20px; max-width: 600px; display: inline-block; }
			.cm .label-video iframe { max-width: 100%; }
			.postbox { min-width: 255px; border: 1px solid #e5e5e5; box-shadow: 0 1px 1px rgba(0,0,0,.04); background: #fff; margin: 10px 10px 10px 0px; border: 1px solid #CCC; }
			.cm .cmlp-box h3 { font-size: 15px; -webkit-box-sizing: content-box; -moz-box-sizing: content-box; box-sizing: content-box; position: relative; min-height: 38px; margin: 0; background: #f7f7f7; background-image: -webkit-linear-gradient(top, white 0, #eeeeee 100%); background-image: linear-gradient(to bottom, #ffffff 0%, #eeeeee 100%); background-repeat: repeat-x; filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ffffffff', endColorstr='#ffeeeeee', GradientType=0); color: #669fc7; border-bottom: 1px solid #DDD; padding-left: 12px; cursor: auto; }
			.cm .cmlp-box h3 span { line-height: 36px; padding: 0; margin: 0; display: inline; }
			.cm .cmlp-box .cmlp-inside:after { content: ''; clear: both; display: block; }
			.cm .cmlp-box .cmlp-inside { margin: 11px 0; position: relative; line-height: 1.4em; font-size: 13px; padding: 0 12px 12px; }
			.cm .cmlp-left.cmlp-box .cmlp-inside .context { float: left; }
			.cm .cmlp-left.cmlp-box .cmlp-inside .context.cmlp-left { width: 42%; }
			.cm .cmlp-left.cmlp-box .cmlp-inside .context.cmlp-left img { display: block; max-width: 100%; height: auto; }
			.cm .cmlp-left.cmlp-box .blue { background-color: #d9edf7; }
			.cm .cmlp-left.cmlp-box .cmlp-inside .context.cmlp-right { width: 58%; }
			.cm .cmlp-left.cmlp-box .cmlp-inside .context.cmlp-right .form-group { margin-bottom: 8px; }
			.cm .cmlp-left.cmlp-box .cmlp-inside .context.cmlp-right .form-group label { font-weight: normal; font-size: 14px; display: inline-block; margin-bottom: 5px; }
			.cm .cmlp-left.cmlp-box .cmlp-inside .context.cmlp-right .form-group .error { color: red; display: none; }
			.cm .cmlp-left.cmlp-box .cmlp-inside .context.cmlp-right .message { color: blue; margin-bottom: 10px; display: none; }
			input.input { border-radius: 0; color: #858585; border: 1px solid #d5d5d5; padding: 5px 4px 6px; font-size: 14px; font-family: inherit; -webkit-box-shadow: none; box-shadow: none; -webkit-transition-duration: .1s; transition-duration: .1s; outline: 0; -webkit-transition: 50ms border-color ease-in-out; transition: 50ms border-color ease-in-out; display: block; width: 100%; height: 34px; box-sizing:border-box; }
			.button-block,
			.button-block:focus { padding: 6px 12px; font-size: 14px; line-height: 1.42857143; -webkit-transition: all ease .15s; transition: all ease .15s; border: 5px solid #FFF; color: #FFF; background-color: #ffb752; border-color: #ffb752; width: 100%; cursor: pointer; }
			.button-block:hover,
			.button-block:focus,
			.button-block:active { background-color: #e59729; border-color: #ffb752; }
			.cm .cmlp-right.cmlp-box .table { width: 100%; margin-bottom: 20px; border-collapse: collapse; border-spacing: 0; }
			.table>thead>tr { color: #707070; font-weight: normal; background: #F2F2F2; background-image: -webkit-linear-gradient(top, #f8f8f8 0, #ececec 100%); background-image: linear-gradient(to bottom, #f8f8f8 0, #ececec 100%); background-repeat: repeat-x; filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#fff8f8f8', endColorstr='#ffececec', GradientType=0); }
			.cm .cmlp-right.cmlp-box .table>caption+thead>tr:first-child>th,
			.cm .cmlp-right.cmlp-box .table>colgroup+thead>tr:first-child>th,
			.cm .cmlp-right.cmlp-box .table>thead:first-child>tr:first-child>th,
			.cm .cmlp-right.cmlp-box .table>caption+thead>tr:first-child>td,
			.cm .cmlp-right.cmlp-box .table>colgroup+thead>tr:first-child>td,
			.cm .cmlp-right.cmlp-box .table>thead:first-child>tr:first-child>td { border-top: 0; }
			.table>thead>tr>th:first-child { border-left-color: #F1F1F1; }
			.table>thead>tr>th { border-color: #ddd; font-weight: bold; vertical-align: bottom; border-bottom: 2px solid #ddd; }
			.cm .cmlp-right.cmlp-box .table>thead>tr>th,
			.cm .cmlp-right.cmlp-box .table>tbody>tr>th,
			.cm .cmlp-right.cmlp-box .table>tfoot>tr>th,
			.cm .cmlp-right.cmlp-box .table>thead>tr>td,
			.cm .cmlp-right.cmlp-box .table>tbody>tr>td,
			.cm .cmlp-right.cmlp-box .table>tfoot>tr>td { padding: 8px; line-height: 1.42857143; vertical-align: top; border-top: 1px solid #ddd; text-align: left; border-radius: 0; }
			.danger { color: #a94442; }
			.cm  a.button { color: #555; border-color: #ccc; background: #f7f7f7; -webkit-box-shadow: 0 1px 0 #ccc; box-shadow: 0 1px 0 #ccc; display: inline-block; text-decoration: none; line-height: 26px; height: 28px; padding: 0 10px 1px; cursor: pointer; border-width: 1px; border-style: solid; -webkit-border-radius: 3px; border-radius: 3px; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; }
			.cm  a.button:active { background: #eee; border-color: #999; -webkit-box-shadow: inset 0 2px 5px -3px rgba(0,0,0,.5); box-shadow: inset 0 2px 5px -3px rgba(0,0,0,.5); -webkit-transform: translateY(1px); -ms-transform: translateY(1px); transform: translateY(1px); }
			.cm  a.button:hover { background: #eee; border-color: #999; -webkit-box-shadow: inset 0 2px 5px -3px rgba(0,0,0,.5); box-shadow: inset 0 2px 5px -3px rgba(0,0,0,.5); -webkit-transform: translateY(1px); -ms-transform: translateY(1px); transform: translateY(1px); }
			.cm  a.buttonblue { color: #fff; border-color: #33ace7; background: #66c1ed; -webkit-box-shadow: 0 1px 0 #ccc; box-shadow: 0 1px 0 #ccc; display: inline-block; text-decoration: none; line-height: 26px; height: 28px; padding: 0 10px 1px; cursor: pointer; border-width: 1px; border-style: solid; -webkit-border-radius: 3px; border-radius: 3px; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; }
			.cm  a.buttonblue:active { background: #0198e1; border-color: #66c1ed; -webkit-box-shadow: inset 0 2px 5px -3px rgba(0,0,0,.5); box-shadow: inset 0 2px 5px -3px rgba(0,0,0,.5); -webkit-transform: translateY(1px); -ms-transform: translateY(1px); transform: translateY(1px); }
			.cm  a.buttonblue:hover { background: #005b87; border-color: #0198e1; -webkit-box-shadow: inset 0 2px 5px -3px rgba(0,0,0,.5); box-shadow: inset 0 2px 5px -3px rgba(0,0,0,.5); -webkit-transform: translateY(1px); -ms-transform: translateY(1px); transform: translateY(1px); }
			.cm  .buttongreen { color: #fff; border-color: #006600; background: #008000; -webkit-box-shadow: 0 1px 0 #ccc; box-shadow: 0 1px 0 #ccc; display: inline-block; text-decoration: none; line-height: 26px; height: 28px; padding: 0 10px 1px; cursor: pointer; border-width: 1px; border-style: solid; -webkit-border-radius: 3px; border-radius: 3px; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; }
			.cm  .buttongreen:active { background: #006600; border-color: #006600; -webkit-box-shadow: inset 0 2px 5px -3px rgba(0,0,0,.5); box-shadow: inset 0 2px 5px -3px rgba(0,0,0,.5); -webkit-transform: translateY(1px); -ms-transform: translateY(1px); transform: translateY(1px); }
			.cm  .buttongreen:hover { background: #006600; border-color: #006600; -webkit-box-shadow: inset 0 2px 5px -3px rgba(0,0,0,.5); box-shadow: inset 0 2px 5px -3px rgba(0,0,0,.5); -webkit-transform: translateY(1px); -ms-transform: translateY(1px); transform: translateY(1px); }
			.cm  a.buttonorange { color: #fff; border-color: #ffb752; background: #ffb752; -webkit-box-shadow: 0 1px 0 #ccc; box-shadow: 0 1px 0 #ccc; display: inline-block; text-decoration: none; line-height: 26px; height: 28px; padding: 0 10px 1px; cursor: pointer; border-width: 1px; border-style: solid; -webkit-border-radius: 3px; border-radius: 3px; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; }
			.cm  a.buttonorange:active { background: #e5a449; border-color: #ffc574; -webkit-box-shadow: inset 0 2px 5px -3px rgba(0,0,0,.5); box-shadow: inset 0 2px 5px -3px rgba(0,0,0,.5); -webkit-transform: translateY(1px); -ms-transform: translateY(1px); transform: translateY(1px); }
			.cm  a.buttonorange:hover { background: #e5a449; border-color: #ffc574; -webkit-box-shadow: inset 0 2px 5px -3px rgba(0,0,0,.5); box-shadow: inset 0 2px 5px -3px rgba(0,0,0,.5); -webkit-transform: translateY(1px); -ms-transform: translateY(1px); transform: translateY(1px); }
			.cm .cmlp-box strong.label-title { position: absolute; top: -1px; right: -1px; height: 40px; padding-left: 15px; padding-right: 15px; border: 1px solid rgba(0,0,0,.1); line-height: 36px; font-size: 14px; background-color: #d15b47; color: #fff; box-sizing: border-box; border-radius: 0; text-shadow: none; }
			.cm .cmlp-box strong.label-title-link { position: absolute; top: -1px; right: -1px; height: 40px; padding-left: 15px; padding-right: 15px; border: 1px solid rgba(0,0,0,.1); line-height: 36px; font-size: 14px; background-color: #ffb752; color: white; box-sizing: border-box; border-radius: 0; text-shadow: none; }
			.label-title-link-class { color: white; text-decoration: none; }
			.cm .cmlp-right.cmlp-box .list { position: relative; display: block; padding: 0 15px; }
			.cm .cmlp-right.cmlp-box .plugins-table { display: table; margin-bottom: 20px; width: 100%; }
			.cm .cmlp-right.cmlp-box .plugins { display: table; margin-bottom: 10px; margin-top: 10px; }
			.cm .cmlp-right.cmlp-box .plugins .item { display: table-cell; vertical-align: middle; text-align: left; padding-right: 10px; }
			.cm .cmlp-right.cmlp-box .plugins-img { width: 20%; }
			.cm .cmlp-right.cmlp-box .plugins-img a { width: auto; display: block; }
			.cm .cmlp-right.cmlp-box .plugins-img a .img { width: 100%; padding-right: 25px; height: 100%; display: block; box-sizing: border-box; }
			.cm .cmlp-right.cmlp-box .plugins-body { padding: 0; width: 45%; }
			.cm .cmlp-right.cmlp-box .plugins-body p { margin: 0; }
			.cm .cmlp-right.cmlp-box .plugins-price { padding: 0; width: 15%; color: #4CAF50; line-height: 1; font-weight: bold; }
			.cm .cmlp-right.cmlp-box .plugins-action { text-align: right; width: 20%; }
			.cm .cmlp-right.cmlp-box .plugins-table .button { width: 100%; }
			.cm .cmlp-right.cmlp-box .plugins .button-success,
			.cm .cmlp-right.cmlp-box .plugins .button-success:focus { text-align: center; padding: 6px 12px; font-size: 12px; line-height: 1.42857143; border: 5px solid #FFF; -webkit-transition: all ease .15s; transition: all ease .15s; background-color: #87b87f; border-color: #87b87f; width: auto; display: block; color: #fff; text-decoration: none; }
			.cm .cmlp-right.cmlp-box .plugins .button-success:hover,
			.cm .cmlp-right.cmlp-box .plugins .button-success:focus,
			.cm .cmlp-right.cmlp-box .plugins .button-success:active { background-color: #629b58; border-color: #87b87f; }
			.cm .cmlp-right.cmlp-box .plugins .button-download,
			.cm .cmlp-right.cmlp-box .plugins .button-download:focus { text-align: center; padding: 6px 12px; font-size: 14px; line-height: 1.42857143; border: 5px solid #FFF; -webkit-transition: all ease .15s; transition: all ease .15s; background-color: #8f8f8f; border-color: #8f8f8f; width: auto; display: block; color: #fff; text-decoration: none; }
			.cm .cmlp-right.cmlp-box .plugins .button-download:hover,
			.cm .cmlp-right.cmlp-box .plugins .button-download:focus,
			.cm .cmlp-right.cmlp-box .plugins .button-download:active { background-color: #5f5f5f; border-color: #8f8f8f; }
			.cm input#cminds_license_key { width: 265px; max-width: 90% !important; }
			
			.cmloc-shortcode-desc {margin: 2em 0;}
			.cmloc-shortcode-desc header {background: #f0f0f0; padding: 0.5em; display: flex;}
			.cmloc-shortcode-desc header h4 {font-size: 150%; flex: 0 0 1; margin: 0; padding: 0;}
			.cmloc-shortcode-desc span {flex: 1; text-align: right;}
			.cmloc-shortcode-desc-inner {margin: 0 2em;}
			.cmloc-shortcode-desc-inner h5 {font-size: 150%; font-weight: normal; border-bottom: 1px dashed #c0c0c0; padding-bottom: 0.2em; margin: 1em 0;}
			.cmloc-shortcode-desc-inner ul li {margin-left: 2em; list-style-type: disc;}
			.cmloc-shortcode-desc-inner p {margin: 1em 0;}
			...
			@media (min-width: 768px) and (max-width: 1024px){
				.cm .form-table th,
				.cm .form-table td { display: block; margin: 5px; width: auto; max-width: 90%; padding: 0; }
			}
			@media(max-width: 768px){
				.cm .cmlp-box { width: 100%; display: block; float: none; }
				.cm .cmlp-left.cmlp-box .cmlp-inside .context { float: none; }
				.cm .cmlp-left.cmlp-box .cmlp-inside .context.cmlp-left,
				.cm .cmlp-left.cmlp-box .cmlp-inside .context.cmlp-right { width: 100%; }
				.cm .cmlp-right.cmlp-box .plugins-table { text-align: center; }
				.cm .cmlp-right.cmlp-box .plugins-table .item { display: inline-block; width: 100%; text-align: center; }
				.cm .cmlp-right.cmlp-box .plugins-img a { width: 70%; margin: 0 auto; }
				.cm .cmlp-right.cmlp-box .plugins-img a .img { padding: 0; }
				.cm .cmlp-right.cmlp-box .list { padding-bottom: 10px; }
				.label-title { display: none; }
				.label-video { display: none; }
				.label-title-link { display: none; }
				.cm .cmlp-right.cmlp-box .plugins-price { padding-bottom: 15px; }
				.cm .cmlp-right.cmlp-box .plugins-body { margin-bottom: 15px; }
			}
			</style>
            <div class="wrap">
                <h2>CM Map Locations</h2>
				<section id="" class="cm">
					<div class="cmlp-box cmlp-padding">
						<div  class="postbox">
							<div class="cmlp-inside">
								<p><strong>Notice: shortcodes are case-sensitive</strong></p>
								<article class="cmloc-shortcode-desc">
									<header>
										<h4>[cmloc-snippet]</h4>
										<span>Shows the location's snippet.</span>
									</header>
									<div class="cmloc-shortcode-desc-inner">
										<h5>Filtering parameters:</h5>
										<ul>
											<li><strong>id</strong> - Location's ID</li>
										</ul>
										<h5>View parameters:</h5>
										<ul>
											<li><strong>featured</strong> - one of: image map</li>
										</ul>
										<h5>Example</h5>
										<p><kbd>[cmloc-snippet id=1 featured="map"] </kbd></p>
									</div>
								</article>
								<article class="cmloc-shortcode-desc">
									<header>
										<h4>[cmloc-location-map]</h4>
										<span>Shows the location map.</span>
									</header>
									<div class="cmloc-shortcode-desc-inner">
										<h5>Filtering parameters:</h5>
										<ul>
										...
										<h5>View parameters:</h5>
										<ul>
											<li><strong>theme</strong> - one of: silver retro dark night aubergine</li>
											<li><strong>mapheight</strong> - pixels height </li>
											<li><strong>mapwidth</strong> - pixels width </li>
											<li><strong>width</strong> - pixels width </li>
											<li><strong>showtitle</strong> - show title </li>
											<li><strong>showdate</strong> - show date 1 to show or 0 to hide</li>
										</ul>
										<h5>Example</h5>
										<p><kbd>[cmloc-location-map theme='silver' id=1 mapwidth=200
												mapheight=200 width=600 showtitle=1 showdate=1]</kbd></p>
									</div>
								</article>
								<article class="cmloc-shortcode-desc onlyinpro">
									<header>
										<h4>[cmloc-locations-map] <span class="cm_field_help_pro">(Only in Pro)</span></h4>
										<span>Shows the location's maps.</span>
									</header>
									<div class="cmloc-shortcode-desc-inner">
										<h5>Filtering parameters:</h5>
										<ul>
											<li><strong>showonlybyparams</strong> - show only by params</li>
											<li><strong>limit</strong> - limit items insert number like 5</li>
											<li><strong>page</strong> - page insert number like 1</li>
											<li><strong>category</strong> - id or slug</li>
											<li><strong>taxonomy_key</strong> - key of taxonomy</li>
										</ul>
										<h5>View parameters:</h5>
										<ul>
											<li><strong>theme</strong> - one of: silver retro dark night aubergine</li>
											<li><strong>list</strong> - one of: none left right bottom compact </li>
											<li><strong>mapwidth</strong> - pixels width </li>
											<li><strong>width</strong> - pixels width </li>
											<li><strong>menu</strong> - show menu, 0 to hide or 1 to show</li>
											<li><strong>tooltip</strong> - show tooltip, 1 to show or 0 to hide</li>
											<li><strong>map</strong> - show map, 1 to show or 0 to hide</li>
											<li><strong>usertracking</strong> - show user track location/path, 1 to show or 0 to hide</li>
											<li><strong>from_date</strong> - date format is DDMMYYYYHHmm e.g. 070520231000 (07/05/2023 10:00 AM)</li>
											<li><strong>to_date</strong> - date format is DDMMYYYYHHmm e.g. 280520232330 (28/05/2023 11:30 PM)</li>
										</ul>
										<h5>Get parameters:</h5>
										<ul>
											<li><strong>identifier</strong> - add identifier</li>
											<li><strong>identifier_filter</strong> - show identifier filter, 1 to show or 0 to hide</li>
											<li><strong>uttype</strong> - add type</li>
											<li><strong>type_filter</strong> - show type filter, 1 to show or 0 to hide</li>
											<li><strong>time_filter</strong> - show time filter, 1 to show or 0 to hide</li>
											<li><strong>from_date</strong> - date format is DDMMYYYYHHmm e.g. 070520231000 (07/05/2023 10:00 AM)</li>
											<li><strong>to_date</strong> - date format is DDMMYYYYHHmm e.g. 280520232330 (28/05/2023 11:30 PM)</li>
											<li><strong>hours</strong> - add hours such as 12, 24, 48</li>
											<li><strong>path</strong> - show path, 1 to show or 0 to hide</li>
										</ul>
										<h5>Example</h5>
										<p><kbd>[cmloc-locations-map showonlybyparams=0 theme='silver' list="left" limit=5 page=1 category="56" mapwidth=600 width=600 menu=0 tooltip=0]</kbd></p>
									</div>
								</article>
								<article class="cmloc-shortcode-desc onlyinpro">
									<header>
										<h4>[cmloc-current-locations-map] <span class="cm_field_help_pro">(Only in Pro)</span></h4>
										<span>Shows the current location's maps.</span>
									</header>
									<div class="cmloc-shortcode-desc-inner">
										<h5>Filtering parameters:</h5>
										<ul>
										...
										<h5>Example</h5>
										<p><kbd>[cmloc-current-locations-map theme='silver' limit=5 page=1 mapwidth=600 width=600 tooltip=0]</kbd></p>
									</div>
								</article>
								<article class="cmloc-shortcode-desc onlyinpro">
									<header>
										<h4>[cmmrm-cmloc-common-map] <span class="cm_field_help_pro">(Only in Pro)</span></h4>
										<span>displays common map with locations and routes from the CM Map Routes Manager plugin.</span>
									</header>
									<div class="cmloc-shortcode-desc-inner">
										<h5>Filtering parameters:</h5>
										<ul>
											<li><strong>showonlybyparams</strong> - show only by params</li>
											<li><strong>categoryfilter</strong> - show only by params</li>
											<li><strong>autoexpandcategoryfilter</strong> - one of:  0 - 1</li>
											<li><strong>categoryfilterautoselect</strong> - show only by params</li>
											<li><strong>showonlybyparams</strong> - show only by params</li>
										...
										<ul>
											<li><strong>theme</strong> - one of: silver retro dark night aubergine</li>
											<li><strong>path</strong> - one of:  0 - 1</li>
											<li><strong>mapheight</strong> - pixels height </li>
											<li><strong>mapwidth</strong> - pixels width </li>
											<li><strong>width</strong> - pixels width </li>
										</ul>
										<h5>Example</h5>
										<p><kbd>[cmmrm-cmloc-common-map theme='silver' path=0 categoryfilter=0 autoexpandcategoryfilter=1 categoryfilterautoselect='' showonlybyparams=0 mapwidth=pixels mapheight=pixels width=pixels menu=0]</kbd></p>
									</div>
								</article>
								<article class="cmloc-shortcode-desc">
									<header>
										<h4>[cm-location-search]</h4>
										<span> display the locations search.</span>
									</header>
									<div class="cmloc-shortcode-desc-inner">
										<h5 class="onlyinpro">Parameters <span class="cm_field_help_pro">(Only in Pro)</span>:</h5>
										<ul class="onlyinpro">
											<li><strong>categories</strong> - 0 to hide or 1 to show, default is 1</li>
											<li><strong>customtax</strong> - 0 to hide or 1 to show, default is 1</li>
											<li><strong>searchinput</strong> - 0 to hide or 1 to show, default is 1</li>
											<li><strong>zipcode</strong> - 0 to hide or 1 to show, default is 1</li>
										</ul>
										<h5>Example</h5>
										<p><kbd>[cm-location-search]</kbd></p>
									</div>
								</article>
								<article class="cmloc-shortcode-desc">
									<header>
										<h4>[my-locations-table]</h4>
										<span>display the user's locations table.</span>
									</header>
								</article>
								<article class="cmloc-shortcode-desc onlyinpro">
									<header>
										<h4>[cmloc-api] <span class="cm_field_help_pro">(Only in Pro)</span></h4>
										<span> Turn the API on and off</span>
									</header>
									<div class="cmloc-shortcode-desc-inner">
										<h5>Parameters:</h5>
										<ul>
											<li><strong>status</strong> - off or on</li>
											<li><strong>output</strong> - use for print an output, 0 to hide or 1 to show, default is 1</li>
										</ul>
										<h5>Example</h5>
										<p><kbd>[cmloc-api status="off"]</kbd></p>
										<p><kbd>[cmloc-api status="off" output="0"]</kbd></p>
										<p><kbd>[cmloc-api status="on"]</kbd></p>
										<p><kbd>[cmloc-api status="on" output="1"]</kbd></p>
									</div>
								</article>
								<article class="cmloc-shortcode-desc onlyinpro">
									<header>
										<h4>[cmloc-business] <span class="cm_field_help_pro">(Only in Pro)</span></h4>
										<span>displays map with the CM Business Directory records.</span>
									</header>
									<div class="cmloc-shortcode-desc-inner">
										<h5>Filtering parameters:</h5>
										<ul>
										...
										<ul>
											<li><strong>theme</strong> - one of: silver retro dark night aubergine</li>
											<li><strong>categoryfilter</strong> 0 or 1</li>
											<li><strong>searchbar</strong> 0 or 1</li>
											<li><strong>mapheight</strong> - pixels height </li>
											<li><strong>mapwidth</strong> - pixels width </li>
											<li><strong>width</strong> - pixels width </li>
											<li><strong>show_map_on_load</strong> - 0 or 1 </li>
											<li><strong>tags</strong> - Specify one or more tags. Important: this parameter accepts only tags which come from the CM Business Directory Pro plugin</li>
										</ul>
										<h5>Example</h5>
										<p><kbd>[cmloc-business category="56" categoryfilter=0 searchbar=0 mapwidth=600 mapheight=500 width=600 theme='silver'] </kbd></p>
									</div>
								</article>
								<article class="cmloc-shortcode-desc onlyinpro">
									<header>
										<h4>[cmloc-expert] <span class="cm_field_help_pro">(Only in Pro)</span></h4>
										<span> displays map with the CM Expert Directory records.</span>
									</header>
									<div class="cmloc-shortcode-desc-inner">
										<h5>Filtering parameters:</h5>
										<ul>
										...
										<h5>Example</h5>
										<p><kbd>[cmloc-expert category="56" categoryfilter=0 searchbar=0 mapwidth=600 mapheight=600 width=600 theme='silver']</kbd></p>
									</div>
								</article>
							</div>
						</div>
